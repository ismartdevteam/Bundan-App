 ...
 */
public class ProductStackView extends FrameLayout{
    ...
    public void likeOrDislike(final boolean choice){


        int sign = choice ==true ? +1 : -1;
        Log.e("likeOrDislike",choice+"--"+sign);
        final View last = mProducts.poll();
        View recycled = getRecycledOrNew();
        if (recycled != null){
